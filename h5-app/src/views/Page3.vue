...
// 动态导入poster图片
const posterImages = {
  'yizheng-1': new URL('@/assets/yz/04/video/仪征/1.png', import.meta.url).href,
  'yizheng-2': new URL('@/assets/yz/04/video/仪征/2.png', import.meta.url).href,
  'yizheng-3': new URL('@/assets/yz/04/video/仪征/3.png', import.meta.url).href,
  'yizheng-4': new URL('@/assets/yz/04/video/仪征/4.png', import.meta.url).href,
  'yizheng-5': new URL('@/assets/yz/04/video/仪征/5.png', import.meta.url).href,
  'laian-1': new URL('@/assets/yz/04/video/来安/1.png', import.meta.url).href,
  'laian-2': new URL('@/assets/yz/04/video/来安/2.png', import.meta.url).href,
  'laian-3': new URL('@/assets/yz/04/video/来安/3.png', import.meta.url).href,
  'liuhe-1': new URL('@/assets/yz/04/video/六合/1.png', import.meta.url).href,
  'liuhe-2': new URL('@/assets/yz/04/video/六合/2.png', import.meta.url).href,
  'liuhe-3': new URL('@/assets/yz/04/video/六合/3.png', import.meta.url).href,
  'jinhu-1': new URL('@/assets/yz/04/video/金湖/1.png', import.meta.url).href,
  'dingyuan-1': new URL('@/assets/yz/04/video/定远/1.png', import.meta.url).href,
  'dingyuan-2': new URL('@/assets/yz/04/video/定远/2.png', import.meta.url).href,
  'dingyuan-3': new URL('@/assets/yz/04/video/定远/3.png', import.meta.url).href,
  'xuyi-1': new URL('@/assets/yz/04/video/盱眙/1.png', import.meta.url).href,
  'xuyi-2': new URL('@/assets/yz/04/video/盱眙/2.png', import.meta.url).href,
  'xuyi-3': new URL('@/assets/yz/04/video/盱眙/3.png', import.meta.url).href,
  'xuyi-4': new URL('@/assets/yz/04/video/盱眙/4.png', import.meta.url).href,
  'xuyi-5': new URL('@/assets/yz/04/video/盱眙/5.png', import.meta.url).href,
  'xuyi-6': new URL('@/assets/yz/04/video/盱眙/6.png', import.meta.url).href,
  'xuyi-7': new URL('@/assets/yz/04/video/盱眙/7.png', import.meta.url).href,
}
...
const citiesData = {
  yizheng: {
    ...
    historyItems: [
      {
        description: '1939年11月，新四军苏皖支队抵达仪征，在陈集镇沙集村成立中共仪征县委。1940年 4月，仪征县抗日民主政府在月塘曹集成立，建立 5个区、 1个办事处和50多个乡政权。在津浦路东省委领导下，广泛动员群众，组织农抗会、青年队、民兵等地方武装，扩大和巩固抗日根据地，成为抗战的坚强堡垒。',
        title: '建立党政军组织​',
	  ...
	  {
        description: '1939年12月18日，日伪军 800余人分三路合击月塘集。苏皖支队避其锋芒，主力转移至移居集隐蔽。傍晚利用地形和群众支援，反击压缩敌人至北大庙，激战三小时收复月塘。此战歼敌90余人，缴获枪械40余支，极大鼓舞军民斗志，成为新四军在仪征的里程碑之战。',
        title: '月塘反击战',
	...
	creativeTeam: {
		totalDirector: "张强",
		totalPlanner: ["窦忠根", "豆维啸"],
		totalProducer: "由方举",
		producer: ["万言", "尹书冬", "巫蓉", "罗海蛟", "唐超"],
		director: ["赵广俊", "蒋宇"],
		visual: ["赵亦明", "宰儒宇", "王冬梅"],
		promotion: ["徐昊晨", "王小丹"]
	}
  ...
  liuhe: {
	...
	creativeTeam: {
		...
		totalPlanner: ["窦忠根", "豆维啸"],
		totalProducer: "由方举",
		producer: ["武峥嵘", "何屹", "薛晓云", "唐宏亮", "张露", "游鹏", "杜森", "董艺旋"],
		director: ["张雅茜", "郑蓉蓉", "许燕", "赵君"],
		visual: ["赵亦明", "宰儒宇", "王冬梅"],
		promotion: ["陆欣", "韩聪聪", "何义红"]
	}
  },
  jinhu: {
    name: '金湖',
  ...
  xuyi: {
	...
	creativeTeam: {
		...
		totalPlanner: ["窦忠根", "豆维啸"],
		totalProducer: "由方举",
		producer: ["贾战军", "王金波", "王礼富"],
		director: ["陈君", "狄晨明", "孟凡婷", "陈帅"],
		visual: ["赵亦明", "宰儒宇", "王冬梅"],
		promotion: ["余露露", "李燕"]
	}
  }
