  ...
  >
    ...
    >
      ...
      >
        ...
        />
        <!-- 彩带装饰 -->
		<img src="@/assets/yz/04/彩带2.png" class="absolute bottom-[1%] left-[23%] w-30 h-30 opacity-80 pointer-events-none z-20 animate-ribbon scale-x-[-1]">
        <img src="@/assets/yz/04/彩带1.png" class="absolute bottom-[7%] right-[-6%] w-30 h-30 opacity-80 pointer-events-none z-20 animate-ribbon scale-x-[-1]">
